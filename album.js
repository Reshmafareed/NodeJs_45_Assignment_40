...
// the number of tracks on an album. If the calling line includes a value for 
...
const album1 = make_album('Artist 1', 'Album Titli 1');
console.log(album1);
const album2 = make_album('Artist 2', 'Album Titli 2');
console.log(album2);
const album3 = make_album('Artist 3', 'Album Titli 3', 12);
console.log(album3);
